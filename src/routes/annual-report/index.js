          ...
          <div class="accordion" id="accordionPanelsStayOpenExample">
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                  Professors, Associate Professors, Assistant Professors and their
                  Ph.D. Specialization
                </button>
              </h2>
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingThree7">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree7" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree7">
              ...
              <div id="panelsStayOpen-collapseThree7" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree7">
                ...
                <div class="accordion m-5" id="accordionPanelsStayOpenExample">
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="panelsStayOpen-headingTwo9">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo9" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo9">
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="panelsStayOpen-headingThree10">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree10" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree10">
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo11">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne11" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne11">
                  Faculty Development
                </button>
              </h2>
              <div id="panelsStayOpen-collapseOne11" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo11">
                <div className="m-5">
                  ...
                  <table class="table table-bordered mt-3 mb-5">
                    <tr><th>Sl. No.</th><th>Faculty name and Designation</th><th>Names of the conference/seminar/symposium attended</th><th>date</th><th>Address of organized Institute</th></tr>
                  </table>
                  <h3 id="title">At International Level(within India)</h3>
                  <table class="table table-bordered mt-3 mb-5">
                    <tr><th>Sl. No.</th><th>Faculty name and Designation</th><th>Names of the conference/seminar/symposium attended</th><th>date</th><th>Address of organized Institute</th></tr>
                    <tr><td>1</td><td>Dr.V Ponnusamy Professor </td><td>Synthesis and
                      photoluminescence of
                      Europium Doped Sodium
                      zirconate silicate Phosphor
                    </td><td>20-21
                      February
                      2020</td><td>2nd International
                        Conference on
                        ...
                        College
                        (Autonomous),</td></tr>
                    <tr><td>2</td><td>Dr.V Ponnusamy
                      Professor </td><td>Photoluminescence properties
                        of Eu3+ Activated SrY2O4 Red
                        emitting Phosphor For Solid
                        State Lighting Application</td><td>20-21
                          February
                          2020
                      </td><td>2nd International
                        Conference on
                        Materials for Energy
                        and Environment
                        (ICMEE-2020) at
                  ...
                  <table class="table table-bordered mt-3 mb-5">
                    <tr><th>Sl. No.</th><th>Faculty name and Designation</th><th>Names of the programme attended</th><th>Name of the country visited</th><th>Name of travel grant used</th><th>Date</th></tr>

                  </table>
                  <h3 id="title">Lectures delivered by the Anna University Faculty members at other Institute</h3>
                  <table class="table table-bordered mt-3 mb-5">
                    <tr><th>Sl. No.</th><th>Faculty name and Designation</th><th>Names of the conference/seminar/symposium attended</th><th>date</th><th>Address of organized Institute</th></tr>
                  </table>
                  <h3 id="title">Honours / Awards received from State / National / International bodies by the AU Faculty Members</h3>
                  <table class="table table-bordered mt-3 mb-5">
                    <tr><th>Sl. No.</th><th>Name of the Faculty</th><th>Designation</th><th>Name of the Honour / Award</th><th>Name of the institute/organization issued the Honours / Awards</th></tr>
                  </table>
                </div>
              </div>
            </div>
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo12">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne12" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne12">
                  Visitors to the Departments/Centres/Institute other than Anna University Faculty
                </button>
              </h2>
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo12">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne13" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne13">
                  New Equipment / Instruments purchased costing above Rs.5.00 lakh
                </button>
              </h2>
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo14">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne14" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne14">
                  Research
                </button>
              </h2>
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo15">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne15" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne15">
                  Journals Published
                </button>
              </h2>
              <div id="panelsStayOpen-collapseOne15" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo15">
                <div className="m-5">
                  ...
                  <table class="table table-bordered mt-3 mb-3">
                    <tr><th>Sl No</th><th>Title</th><th>Author's Name</th><th>Name of the Publisher</th><th>Month and Year</th></tr>
                  </table>
                  <h3 id="title">In International Journals</h3>
                  <table class="table table-bordered mt-3 mb-3">
                    <tr><th>Sl No</th><th>Title</th><th>Author's Name</th><th>Name of the Publisher</th><th>Month and Year</th></tr>
                    <tr><td>1</td><td>A development of new red
                      phosphor based on
                      europium doped as well as
                      substituted Barium
                      Lanthanum Aluminate
                      (BaLaAlO4: Eu3+) </td><td>A.Azhagiria,
                        V.Ponnusamy,R.Satheesh
                        Kumar
                      </td><td>ScienceDirect
                        (Elsevier B.V)
                        Optical materials,
                        Volume 90,
                        Pages 127-138</td><td>April 2019</td></tr>
                    <tr><td>2</td><td>Development of novel
                      Na2Mg3Zn2Si12O30:Eu3+red
                      phosphor for white light
                      emitting diodes </td><td>G.V.Kanmani,
                        V.Ponnusamy,
                        G.Rajkumar, M.T.Jose.
                      </td><td>ScienceDirect
                        (Elsevier B.V)
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo16">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne16" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne16">
            ...
            <div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo17">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne17" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne17">
                Patents obtained
                </button>
              </h2>
            ...
            </div><div class="accordion-item nesteditem">
              <h2 class="accordion-header" id="panelsStayOpen-headingTwo18">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne18" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne18">
                Achievements
                </button>
              </h2>
              <div id="panelsStayOpen-collapseOne18" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo18">
              </div>
            </div>
          </div>
        </div>
